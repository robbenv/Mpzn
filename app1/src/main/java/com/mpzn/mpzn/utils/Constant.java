...
public class Constant  {
    ...
    public static String[] USERTOOLS={
            ...
            "报备统计","楼盘代销","楼盘意向","代销管理","我的代销","经纪人管理","驻场核验","更多"};
    ...
    public static int[] USERTOOLIMGS={R.drawable.look_his,R.drawable.favorite,
            ...
            R.drawable.my_sell, R.drawable.agent_manage,R.drawable.checkbaobei,R.drawable.user_tool_more};
    public static int[] USERTOOL_DEFAULT={0,1,12};
    public static int[] USERTOOL_JINGJIREN={0,1,2,4,5,12};
    public static int[] USERTOOL_JINGJICOM={0,1,3,4,5,6,9,10,12};
    public static int[] USERTOOL_KAIFASHANG={0,1,5,8,11,12};
