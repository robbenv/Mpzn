package com.mpzn.mpzn.views.FilterView;
...
import com.mpzn.mpzn.views.FilterView.adapter.FilterLeftAdapter;
import com.mpzn.mpzn.views.FilterView.adapter.FilterOneAdapter;
import com.mpzn.mpzn.views.FilterView.adapter.FilterRightAdapter;
...
public class FilterView extends LinearLayout implements View.OnClickListener {
    ...
    private void setCategoryAdapter() {
        tvCategory.setTextColor(mActivity.getResources().getColor(R.color.red_theme));
    ...
    private void setSortAdapter() {
        tvSort.setTextColor(mActivity.getResources().getColor(R.color.red_theme));
    ...
    private void setFilterAdapter() {
        tvFilter.setTextColor(mActivity.getResources().getColor(R.color.red_theme));
