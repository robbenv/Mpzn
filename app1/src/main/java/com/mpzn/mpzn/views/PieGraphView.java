...
import com.mpzn.mpzn.utils.GeomTool;
...
public class PieGraphView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        ItemGroup group = mGroups[mCurrentGroup];
        String title = group.items[mCurrentItem].id;
    ...
    public void showOutGroup(int index) {
        Log.i("static_test", "showOutGroup()__");
        mRotation = 0;
        mRotateDelta = 0;
        mCurrentItem = 0;
        mCurrentGroup = index;
    ...
    public void runShowOutAnim() {
        Log.i("static_test", "runShowOutAnim()__");
        clearAnimation();
    ...
    public boolean onTouchEvent(MotionEvent event) {
        Log.i("static_test", "onTouchEvent()__event = "+event.getAction());
        Log.i("static_test", "onTouchEvent()__mAnimMode = "+mAnimMode);
        ...
        if (event.getAction() == MotionEvent.ACTION_UP && mAnimMode == ANIM_MODE_NONE) {
