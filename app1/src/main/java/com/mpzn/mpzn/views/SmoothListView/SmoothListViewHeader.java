package com.mpzn.mpzn.views.SmoothListView;
...
import com.mpzn.mpzn.views.MyView;


public class SmoothListViewHeader extends LinearLayout {
	private LinearLayout mContainer;
	private MyView mArrowImageView;
//	private MyView mProgressBar;
	...
	private void initView(Context context) {
		...
		mArrowImageView = (MyView)findViewById(R.id.smoothlistview_header_arrow);


		mHintTextView = (TextView)findViewById(R.id.smoothlistview_header_hint_textview);
//		mProgressBar = (MyView)findViewById(R.id.smoothlistview_header_progressbar);
...
//			mProgressBar.setVisibility(View.VISIBLE);
			mArrowImageView.startReFresh();

		} else {	// 显示箭头图片
//			mArrowImageView.setVisibility(View.VISIBLE);
//			mProgressBar.setVisibility(View.INVISIBLE);
			mArrowImageView.stopReFresh();
		}
